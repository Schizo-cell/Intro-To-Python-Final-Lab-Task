...
access_list_element(numbers, 3)
access_list_element(numbers, 12)
access_list_element(numbers, "b")
...
create_new_file(file_path, "Hello World\n")
create_new_file(file_path, "Hello Once More\n")

write_to_file(file_path, "This line was added using write mode.\n")
append_to_file(file_path, "This line was added using append mode.\n")
read_from_file(file_path)

read_from_file(os.path.join(folder_path, "notfound.txt"))
